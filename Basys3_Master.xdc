...
#set_property PACKAGE_PIN R2 [get_ports {Sel2}]					
...
set_property PACKAGE_PIN E19 [get_ports {Infinit}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Infinit}]
set_property PACKAGE_PIN U19 [get_ports {NaN}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {NaN}]
...
#set_property PACKAGE_PIN U14 [get_ports {JA[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JA[6]}]
#set_property PACKAGE_PIN V14 [get_ports {JA[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {JA[7]}]
set_property PACKAGE_PIN V13 [get_ports {Finish}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Finish}]
#set_property PACKAGE_PIN V3 [get_ports {Digit_Select[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Digit_Select[0]}]
#set_property PACKAGE_PIN W3 [get_ports {Digit_Select[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Digit_Select[1]}]
#set_property PACKAGE_PIN U3 [get_ports {Digit_Select[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Digit_Select[2]}]
set_property PACKAGE_PIN P3 [get_ports {Decode[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Decode[3]}]
set_property PACKAGE_PIN N3 [get_ports {Decode[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Decode[2]}]
set_property PACKAGE_PIN P1 [get_ports {Decode[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Decode[1]}]
set_property PACKAGE_PIN L1 [get_ports {Decode[0]}]					
...
set_property PACKAGE_PIN T18 [get_ports LoadX]						
	set_property IOSTANDARD LVCMOS33 [get_ports LoadX]
set_property PACKAGE_PIN W19 [get_ports LoadY]						
	set_property IOSTANDARD LVCMOS33 [get_ports LoadY]
set_property PACKAGE_PIN T17 [get_ports Rst]						
	set_property IOSTANDARD LVCMOS33 [get_ports Rst]
set_property PACKAGE_PIN U17 [get_ports Shift]						
